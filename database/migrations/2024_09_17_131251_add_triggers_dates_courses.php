...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Controla que las fechas de los cursos sean consecutivas
     */
    public function up(): void
    {
        ...
        $tableName = $tablePrefix . (new CoursesModel())->getTable();

        DB::unprepared("
            CREATE TRIGGER check_courses_inscription_finish_date_insert
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_inscription_finish_date_before_update
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_enrolling_start_date_before_insert
            BEFORE INSERT ON {$tableName}
            FOR EACH ROW
            BEGIN
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_enrolling_start_date_before_update
            BEFORE UPDATE ON {$tableName}
            FOR EACH ROW
            BEGIN
                IF NEW.enrolling_start_date < NEW.inscription_finish_date THEN
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_enrolling_finish_date_before_insert
            BEFORE INSERT ON {$tableName}
            FOR EACH ROW
            BEGIN
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_enrolling_finish_date_before_update
            BEFORE UPDATE ON {$tableName}
            FOR EACH ROW
            BEGIN
                IF NEW.enrolling_finish_date < NEW.enrolling_start_date THEN
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_realization_start_date_before_insert
            BEFORE INSERT ON {$tableName}
            FOR EACH ROW
            BEGIN
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_realization_start_date_before_update
            BEFORE UPDATE ON {$tableName}
            FOR EACH ROW
            BEGIN
                IF NEW.realization_start_date < NEW.enrolling_finish_date OR NEW.realization_start_date < NEW.inscription_finish_date
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_realization_finish_date_before_insert
            BEFORE INSERT ON {$tableName}
            FOR EACH ROW
            BEGIN
        ...
        DB::unprepared("
            CREATE TRIGGER check_courses_realization_finish_date_before_update
            BEFORE UPDATE ON {$tableName}
            FOR EACH ROW
            BEGIN
                IF NEW.realization_finish_date < NEW.realization_start_date THEN
