<footer class="bg-white border-t">
    <div class="hidden lg:flex justify-between py-20 border-b border-gray-100 container mx-auto items-center">

        <div>
            <a href="/" class="">
                <img src="{{ env('BACKEND_URL') . '/' . $general_options['poa_logo'] }}" class="mr-3 w-[212px] h-[75px]"
                    alt="Logo header">
            </a>
        </div>
    ...
    <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 mx-auto  text-center lg:text-left  gap-8 container mt-32 mb-32">
        <div>
            <p class="font-bold text-[--footer-title-color] text-xl leading-[22px] mb-7">Programas</p>
        ...
        <div>
            <p class="font-bold text-[--footer-title-color] text-xl leading-[22px]	mb-7">Universidad</p>
        ...
        <div>
            <p class="font-bold text-[--footer-title-color] text-xl leading-[22px]	mb-7">El Portal</p>
        ...
        <div>
            <p class="font-bold text-[--footer-title-color] text-xl leading-[22px]	mb-7">Acerca de</p>
        ...
        <div class="flex-col gap-[40px] hidden lg:flex">
            <p class="font-bold text-[--footer-title-color] text-xl leading-[22px]">¿Aún no encuentras lo que buscas?
            </p>
            <p class="leading-6">Lorem ipsum dolor sit amet consectetur adipiscing elit aliquam mauris sed ma</p>
            <div
                class=" bg-white items-center justify-between p-1 border border-[--secondary-color] rounded-xl my-auto  lg:flex hidden min-w-[150px] w-full max-w-[348px]">
    ...
    <div class="border-t container mx-auto flex justify-between py-[38px] lg:flex-row flex-col gap-4 items-center">
        <div class="text-sm text-gray-500">
            © 2023 {{ $general_options['company_name'] }}. Todos los derechos reservados.
        </div>
            ...
            @if ($general_options['facebook_url'])
                <div>
                    <a href="{{ $general_options['facebook_url'] }}" rel="noreferrer" target="_blank"
                        ...
                        <svg class="h-6 w-6 fill-primary" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            @if ($general_options['youtube_url'])
                <div>
                    <a href="{{ $general_options['youtube_url'] }}" rel="noreferrer" target="_blank"
                        ...
                        <svg class="h-6 w-6 fill-primary" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="21"
                            height="16" viewBox="0 0 21 16">
                            <path
            ...
            @if ($general_options['linkedin_url'])
                <div>
                    <a href="{{ $general_options['linkedin_url'] }}" rel="noreferrer" target="_blank"
                        ...
                        <svg class="h-6 w-6 fill-primary" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="19"
