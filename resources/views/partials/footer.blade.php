    ...
    <div class="lg:flex lg:gap-8 container mx-auto mt-[51px] mb-[30px] ">
        ...
        <div class="flex-col gap-[40px] hidden lg:flex w-1/2">
            ...
            <div
                ...
                <input aria-label="Buscar" id="searcher_button_footer"
    ...
    <div class="container mx-auto flex justify-between py-[38px] lg:flex-row gap-[20px] flex-col-reverse items-center">
        ...
        @if (
            $general_options['facebook_url'] ||
                $general_options['instagram_url'] ||
                $general_options['x_url'] ||
                $general_options['youtube_url'] ||
                $general_options['linkedin_url']
        )
