...
<body>
    ...
    <a aria-label="enlace" href="{{ $parameters['url'] }}&token={{ $parameters['token'] }}" style="background-color: {{app('general_options')['color_1']}}; color: white; padding: 10px 20px; text-decoration: none;">Verificar cuenta de correo electrónico</a>
