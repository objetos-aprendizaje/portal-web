...
return [
    ...
    */
    ...
    'contactPerson' => [
        'technical' => [
            'givenName' => env('SAML2_CONTACT_TECHNICAL_NAME', 'Contacto'),
            'emailAddress' => env('SAML2_CONTACT_TECHNICAL_EMAIL', 'desarrollo@grupomainjobs.com')
        ],
        'support' => [
            'givenName' => env('SAML2_CONTACT_SUPPORT_NAME', 'Contacto'),
            'emailAddress' => env('SAML2_CONTACT_SUPPORT_EMAIL', 'desarrollo@grupomainjobs.com')
        ],
    ],
    ...
    */
    ...
    'organization' => [
        'es-ES' => [
            'name' => env('SAML2_ORGANIZATION_NAME', 'GRUPOMAINJOBS'),
            'displayname' => env('SAML2_ORGANIZATION_NAME', 'GRUPOMAINJOBS'),
            'url' => env('SAML2_ORGANIZATION_URL', 'https://grupomainjobs.com/')
        ],
    ],
